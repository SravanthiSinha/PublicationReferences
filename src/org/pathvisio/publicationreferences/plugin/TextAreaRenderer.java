...
public class TextAreaRenderer extends JTextArea implements TableCellRenderer { 
    ...
    PublicationReferencePlugin RPlugin;
     ...
     */ 
    public TextAreaRenderer(PublicationReferencePlugin publicationReferencePlugin) { 
        this.RPlugin=publicationReferencePlugin;
    	setLineWrap(true); 
    ...
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, 
        ...
        String ttText=null;
       Map<Integer, List<String>> resource = RPlugin.resource;
        if(resource.size()!=0){
        	
        	ttText=resource.get(1).get(0).toString() ;
